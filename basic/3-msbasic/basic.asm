; =============================================================================
;  MS-style BASIC  --  an Applesoft-flavored BASIC for the e6502 emulator
;  Released to the public domain (CC0 1.0)
;
;  Tier 3 of the e6502 BASIC family: extends Integer BASIC with string
;  variables and functions, numeric functions, DATA/READ, and ON..GOTO/GOSUB.
;  Arithmetic remains 16-bit integer (no floating point) - "Microsoft BASIC in
;  feature shape", not a bit-exact Applesoft.
;
;  Supported features
;  ------------------
...
crd_var: jsr  SKIP_SPC
         jsr  GET_VARLET      ; variable letter
         sta  TMP
         jsr  DATA_VAL        ; next DATA value -> AR
...
sf_mid:  jsr  GETCH           ; '$'
         ...
         jsr  SKIP_SPC
         jsr  GETCH           ; ','
         jsr  EVAL_EXPR       ; start (1-based) -> AR
         lda  AR
         sec
         sbc  #1
         ...
         bne  mid_deflen
         jsr  GETCH
         jsr  EVAL_EXPR       ; explicit length -> AR
         lda  AR
         sta  CNT
         jmp  mid_close
mid_deflen:
